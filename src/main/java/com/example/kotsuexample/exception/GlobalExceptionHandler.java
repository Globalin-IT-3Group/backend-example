...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorResponseDTO> catchFriendNotFoundException(FriendNotFoundException e) {
        ErrorResponseDTO errorResponseDTO = ErrorResponseDTO.builder()
                .message(e.getMessage())
                .build();
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorResponseDTO> catchNotificationNotFoundException(NotificationNotFoundException e) {
        ErrorResponseDTO errorResponseDTO = ErrorResponseDTO.builder()
                .message(e.getMessage())
                .build();
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorResponseDTO> catchNotificationNotFoundException(NotificationAccessDeniedException e) {
        ErrorResponseDTO errorResponseDTO = ErrorResponseDTO.builder()
                .message(e.getMessage())
                .build();
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorResponseDTO> catchChatRoomNotFoundException(ChatRoomNotFoundException e) {
        ErrorResponseDTO errorResponseDTO = ErrorResponseDTO.builder()
                .message(e.getMessage())
                .build();
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorResponseDTO> catchNoAuthorizationException(NoAuthorizationException e) {
        ErrorResponseDTO errorResponseDTO = ErrorResponseDTO.builder()
                .message(e.getMessage())
                .build();
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorResponseDTO> catchExceedStudyMemberException(ExceedStudyMemberException e) {
        ErrorResponseDTO errorResponseDTO = ErrorResponseDTO.builder()
                .message(e.getMessage())
                .build();
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorResponseDTO> catchOperationNotAllowedException(OperationNotAllowedException e) {
        ErrorResponseDTO errorResponseDTO = ErrorResponseDTO.builder()
                .message(e.getMessage())
                .build();
